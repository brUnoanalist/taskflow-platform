...
from .views import TaskCreateView,TaskDetailView, TaskDetailView, AcceptTaskView, CompleteTaskView, PayTaskView, TaskUpdateView, CancelTaskView, MyTasksListView
